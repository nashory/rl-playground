# tutorial code. (pyode.sourceforge.net/tutorials/tutorial3.html)
...
def prepare_GL():
    ...
    glLoadIdentity()
    gluPerspective(45.1, 1.3333, 0.2, 20)
...
def pull():
    ...
    Every couple of frames there will be a thrust upwards so that
...
glutCreateWindow("collision test window")
